...
CREATE TABLE PRODUCTOXPLAN(
  ...
  PRIMARY KEY (IDPlan,CodigoDBarras,IdTiempo)
);
...
/*  llaves foraneas a IdTiempo*/
/*13*/
ALTER TABLE PRODUCTOXPLAN
ADD CONSTRAINT PRODUCTOXPLAN_TIEMPODCOMIDA_FK FOREIGN KEY (IdTiempo)
REFERENCES TIEMPODCOMIDA(IdTiempo);

/*  llaves foraneas a AdminID*/
/*14*/
ALTER TABLE PRODUCTO
ADD CONSTRAINT PRODUCTO_ADMINISTRADOR_FK FOREIGN KEY (AdminID)
REFERENCES ADMINISTRADOR(AdminID);