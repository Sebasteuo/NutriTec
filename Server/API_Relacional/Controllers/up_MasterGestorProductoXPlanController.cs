...
namespace API_Relacional.Controllers
{
    ...
    [ApiController]
    public class up_MasterGestorProductoXPlanController : ControllerBase
    {
        ...
        public up_MasterGestorProductoXPlanController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public JsonResult Post(ProductoXPlan x, string statementtype)
        {
            string query = @"
                exec dbo.up_MasterGestorProductoXPlan @idplan, @codigodbarras, @idtiempo, @statementtype
                ";
