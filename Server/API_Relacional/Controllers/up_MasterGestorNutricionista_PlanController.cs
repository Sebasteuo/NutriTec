...
namespace API_Relacional.Controllers
{
    ...
    [ApiController]
    public class up_MasterGestorNutricionista_PlanController : ControllerBase
    {
        ...
        public up_MasterGestorNutricionista_PlanController(IConfiguration configuration)
        {
