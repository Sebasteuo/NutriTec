...
namespace API_Relacional.Controllers
{
    ...
    [ApiController]
    public class up_MasterGestorRecetaXPlanController : ControllerBase
    {
        ...
        public up_MasterGestorRecetaXPlanController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public JsonResult Post(RecetaXPlan x, string statementtype)
        {
            string query = @"
                exec dbo.up_MasterGestorRecetaXPlan  @idplan, @idreceta, @statementtype
                ";
