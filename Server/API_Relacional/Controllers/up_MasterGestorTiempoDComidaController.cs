...
namespace API_Relacional.Controllers
{
    ...
    [ApiController]
    public class up_MasterGestorTiempoDComidaController : ControllerBase
    {
        ...
        public up_MasterGestorTiempoDComidaController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public JsonResult Post(TiempoComida x, string statementtype)
        {
            string query = @"
                exec dbo.up_MasterGestorTiempoDComida  @idtiempo, @nombre, @statementtype
                ";
