...
namespace API_Relacional.Controllers
{
    ...
    [ApiController]
    public class PlanDComidaController : ControllerBase
    {
        ...
        public PlanDComidaController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public JsonResult Post(PlanDComida x)
        {
            string query = @"
                insert into plandcomida(idplan, nombre)
        ...
        [HttpPut("{id}")]
        public JsonResult Put(PlanDComida x)
        {
            string query = @"
                UPDATE plandcomida
                SET idplan = @idplan,
