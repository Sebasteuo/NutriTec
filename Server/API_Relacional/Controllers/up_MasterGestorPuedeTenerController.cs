...
namespace API_Relacional.Controllers
{
    ...
    [ApiController]
    public class up_MasterGestorPuedeTenerController : ControllerBase
    {
        ...
        public up_MasterGestorPuedeTenerController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public JsonResult Post(Puede_Tener x, string statementtype)
        {
            string query = @"
                exec dbo.up_MasterGestorPuedeTener @codigonutricionista, @cedula, @chatid, @statementtype
                ";
