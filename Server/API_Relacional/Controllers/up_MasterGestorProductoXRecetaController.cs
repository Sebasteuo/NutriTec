...
namespace API_Relacional.Controllers
{
    ...
    [ApiController]
    public class up_MasterGestorProductoXRecetaController : ControllerBase
    {
        ...
        public up_MasterGestorProductoXRecetaController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public JsonResult Post(ProductoXReceta x, string statementtype)
        {
            string query = @"
                exec dbo.up_MasterGestorProductoXReceta @idreceta, @codigodbarras, @statementtype
                ";
