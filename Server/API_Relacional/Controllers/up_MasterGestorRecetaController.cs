...
namespace API_Relacional.Controllers
{
    ...
    public class up_MasterGestorRecetaController : ControllerBase
    {
        ...
        public up_MasterGestorRecetaController(IConfiguration configuration)
        {
        ...
        [HttpPost]
        public JsonResult Post(Receta x, string statementtype)
        {
            string query = @"
                exec dbo.up_MasterGestorReceta @idreceta, @nombre, @statementtype
                ";
